...
/* routes/5xx.html generated by Svelte v2.6.1 */


function add_css() {
	var style = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__["createElement"])("style");
	style.id = 'svelte-13qkn6k-style';
	style.textContent = "h1.svelte-13qkn6k{text-align:center;margin:0 auto;font-size:2.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0}@media(min-width: 480px){h1.svelte-13qkn6k{font-size:4em}}";
...
function create_main_fragment(component, ctx) {
	...
	return {
		c() {
			...
			text_1 = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__["createText"])("Internal server error");
			this.h()
		},
		...
		l(nodes) {
			...
			text_1 = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__["claimText"])(h1_nodes, "Internal server error");
...
function _5xx(options) {
	...
	if (!document.getElementById("svelte-13qkn6k-style")) add_css();
...
if (true) {
	...
	if (!module.hot.data) {
		// initial load
		configure({});
		_5xx = register("routes/5xx.html", _5xx);
	} else {
		// hot update
		_5xx = reload("routes/5xx.html", _5xx);
	}
}
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJkZWNmOGMyNTdiODA0ZTFkMWM5NC9fNXh4Ll81eHguanMiLCJzb3VyY2VzQ29udGVudCI6W10sInNvdXJjZVJvb3QiOiIifQ==